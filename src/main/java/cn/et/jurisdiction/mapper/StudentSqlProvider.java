...
import cn.et.jurisdiction.entity.StudentExample.Criterion;
...
public class StudentSqlProvider {
    ...
    public String insertSelective(Student record) {
        ...
        if (record.getStuid() != null) {
            sql.VALUES("stuid", "#{stuid,jdbcType=INTEGER}");
        }
        
        if (record.getStuname() != null) {
            sql.VALUES("stuname", "#{stuname,jdbcType=VARCHAR}");
        }
        
        if (record.getStusex() != null) {
            sql.VALUES("stusex", "#{stusex,jdbcType=VARCHAR}");
        }
        
        if (record.getStuage() != null) {
            sql.VALUES("stuage", "#{stuage,jdbcType=INTEGER}");
        }
        
        if (record.getBordate() != null) {
            sql.VALUES("bordate", "#{bordate,jdbcType=TIMESTAMP}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getStuid() != null) {
            sql.SET("stuid = #{record.stuid,jdbcType=INTEGER}");
        }
        
        if (record.getStuname() != null) {
            sql.SET("stuname = #{record.stuname,jdbcType=VARCHAR}");
        }
        
        if (record.getStusex() != null) {
            sql.SET("stusex = #{record.stusex,jdbcType=VARCHAR}");
        }
        
        if (record.getStuage() != null) {
            sql.SET("stuage = #{record.stuage,jdbcType=INTEGER}");
        }
        
        if (record.getBordate() != null) {
            sql.SET("bordate = #{record.bordate,jdbcType=TIMESTAMP}");
        }
    ...
    public String updateByPrimaryKeySelective(Student record) {
        ...
        if (record.getStuname() != null) {
            sql.SET("stuname = #{stuname,jdbcType=VARCHAR}");
        }
        
        if (record.getStusex() != null) {
            sql.SET("stusex = #{stusex,jdbcType=VARCHAR}");
        }
        
        if (record.getStuage() != null) {
            sql.SET("stuage = #{stuage,jdbcType=INTEGER}");
        }
        
        if (record.getBordate() != null) {
            sql.SET("bordate = #{bordate,jdbcType=TIMESTAMP}");
        }
        ...
        sql.WHERE("stuid = #{stuid,jdbcType=INTEGER}");
